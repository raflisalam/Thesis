...
object YOLOv5Constants {
    ...
    val output_size : IntArray = UtilsClassifier.calculateOutputSize(input_size.width, 80) // Ubah ke 25 (sesuaikan sama banyak label sibi kamu )
    val detected_threshold : Float = 0.5f
    val IOU_threshold : Float = 0.8f
    val IOU_class_duplicated : Float = 0.8f
    val label_file : String = "label_obj_detection.txt" // ( Ubah kenama file labelnya )
    val model_file : String = "yolov5n-fp16-320.tflite" // Ubah kenama file tflitenya )
